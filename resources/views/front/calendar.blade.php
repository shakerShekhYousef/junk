        ...
        <main class="Main Main--page">
            <section>
                <div>
                    ...
                    <iframe id="glofox_1"
                        src="https://app.glofox.com/portal/#/branch/61b2187f0f16027667682fe3/classes-week-view?header=classes"
                        width="100%" height="0" scrolling="no" frameborder="0"></iframe>
                    <div
                        style="display:flex; justify-content:center; text-decoration:none;font-family: Arial, Helvetica, sans-serif;">
                ...
                <div class="sche-section">
                        ...
                        <div class="col-md-3 col-sm-4 col-4">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a
                                        href="{{ route('web_calander_data_show', [0, session()->get('musicid', 0), session()->get('coachid', 0), session()->get('weekid', 0), 3]) }}">Classes</a>
                                    @foreach ($classeslist as $class)
                                        <a
                                            href="{{ route('web_calander_data_show', [$class->id, session()->get('musicid', 0), session()->get('coachid', 0), session()->get('weekid', 0), 3]) }}">{{ $class->name }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-4 col-4">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content drop3">
                                    ...
                                    <a
                                        href="{{ route('web_calander_data_show', [session()->get('classid', 0), session()->get('musicid', 0), 0, session()->get('weekid', 0), 3]) }}">
                                        Coaches</a>
                                    @foreach ($coaches as $coach)
                                        <a
                                            href="{{ route('web_calander_data_show', [session()->get('classid', 0), session()->get('musicid', 0), $coach->id, session()->get('weekid', 0), 3]) }}">{{ $coach->username() }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pt-5" style="justify-content: space-between;">
                        <div class="col-lg-4 col-md-6 col-6">
                            <button class="btn prev" style="color: #000!important"
                                onclick="window.location='{{ route('web_calander_data_show') . '/' . session()->get('classid', 0) . '/' . session()->get('musicid', 0) . '/' . session()->get('coachid', 0) . '/' . (session()->get('weekid', 0) > 0 ? (int) session()->get('weekid', 0) - 1 : 0) . '/1' }}'">
                                <i class="fa fa-step-backward" aria-hidden="true"></i> Prev</button>
                        </div>
                        @auth
                            @if (Auth::user()->hasfrozenpackages())
                                <div class="col-md-4 d-flex justify-content-center none" style="color: rgb(248, 3, 3)">
                                    <small>Frozen*</small>&nbsp;&nbsp;
                                    <b> Current balance: &nbsp;</b> {{ $balance }} / &nbsp;
                                    <b>Booked:&nbsp;</b>{{ $bookedbalance }}
                                </div>
                            @else
                                <div class="col-md-4 d-flex justify-content-center none" style="color: white">
                                    <b> Current balance: &nbsp;</b> {{ $balance }} / &nbsp;
                                    <b>Booked:&nbsp;</b>{{ $bookedbalance }}
                                </div>
                            @endif
                        ...
                        <div class="col-lg-4 col-md-6 col-6 text-right">
                            <button class="btn next" style="color: #000!important"
                                onclick="window.location='{{ route('web_calander_data_show') . '/' . session()->get('classid', 0) . '/' . session()->get('musicid', 0) . '/' . session()->get('coachid', 0) . '/' . ((int) session()->get('weekid', 0) + 1) . '/2' }}'">Next
                                <i class="fa fa-step-forward" aria-hidden="true"></i></button>
                        </div>
                        <div class="col-md-12 text-center  none1" style="color: white">
                            @auth
                                <b> Current balance: &nbsp;</b> {{ $balance }} / &nbsp;
                                <b>Booked:&nbsp;</b>{{ $bookedbalance }}
                            @endauth
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($data['sun'] as $sun)
                                            @if ($sun['previous'] != true)
                                                @if ($sun['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $sun['id']) }}" .
                                                            {{ $sun['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $sun['class_name'] }}</h6>
                                                                <img src="{{ asset($sun['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $sun['music_name'] }}</p>
                                                            <p>{{ $sun['coach_name'] }}</p>
                                                            @isset($sun['start_at'])
                                                    ...
                                                    <div style=" padding-top: 3%">
                                                        <form method="post" action="{{ $sun['UnBook'] }}">
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $sun['id'], 'date' => $sun['bookdate']]) }}"
                                                                . {{ $sun['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $sun['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['mon'] as $mon)
                                            @if ($mon['previous'] != true)
                                                @if ($mon['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $mon['id']) }}" .
                                                            {{ $mon['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $mon['class_name'] }}</h6>
                                                                <img src="{{ asset($mon['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $mon['music_name'] }}</p>
                                                            <p>{{ $mon['coach_name'] }}</p>
                                                    ...
                                                    <div style="  padding-top: 3%">
                                                        <form method="post" action="{{ $mon['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $mon['id'], 'date' => $mon['bookdate']]) }}"
                                                                . {{ $mon['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $mon['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['tue'] as $tue)
                                            @if ($tue['previous'] != true)
                                                @if ($tue['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $tue['id']) }}" .
                                                            {{ $tue['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $tue['class_name'] }}</h6>
                                                                <img src="{{ asset($tue['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $tue['music_name'] }}</p>
                                                            <p>{{ $tue['coach_name'] }}</p>
                                                    ...
                                                    <div style=" padding-top: 3%">
                                                        <form method="post" action="{{ $tue['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $tue['id'], 'date' => $tue['bookdate']]) }}"
                                                                . {{ $tue['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $tue['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['wed'] as $wed)
                                            @if ($wed['previous'] != true)
                                                @if ($wed['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $wed['id']) }}" .
                                                            {{ $wed['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $wed['class_name'] }}</h6>
                                                                <img src="{{ asset($wed['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $wed['music_name'] }}</p>
                                                            <p>{{ $wed['coach_name'] }}</p>
                                                    ...
                                                    <div style=" padding-top: 3%">
                                                        <form method="post" action="{{ $wed['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $wed['id'], 'date' => $wed['bookdate']]) }}"
                                                                . {{ $wed['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $wed['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['thu'] as $thu)
                                            @if ($thu['previous'] != true)
                                                @if ($thu['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $thu['id']) }}" .
                                                            {{ $thu['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $thu['class_name'] }}</h6>
                                                                <img src="{{ asset($thu['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $thu['music_name'] }}</p>
                                                            <p>{{ $thu['coach_name'] }}</p>
                                                    ...
                                                    <div style=" padding-top: 3%">
                                                        <form method="post" action="{{ $thu['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $thu['id'], 'date' => $thu['bookdate']]) }}"
                                                                . {{ $thu['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $thu['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['fri'] as $fri)
                                            @if ($fri['previous'] != true)
                                                @if ($fri['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $fri['id']) }}" .
                                                            {{ $fri['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $fri['class_name'] }}</h6>
                                                                <img src="{{ asset($fri['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $fri['music_name'] }}</p>
                                                            <p>{{ $fri['coach_name'] }}</p>
                                                    ...
                                                    <div style="padding-top: 3%">
                                                        <form method="post" action="{{ $fri['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $fri['id'], 'date' => $fri['bookdate']]) }}"
                                                                . {{ $fri['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $fri['class_name'] }}</h6>
                                    ...
                                    <td>
                                        @foreach ($data['sat'] as $sat)
                                            @if ($sat['previous'] != true)
                                                @if ($sat['booked'])
                                                    <div class="disabled">
                                                        <a href="{{ route('web_calander_data', $sat['id']) }}" .
                                                            {{ $sat['id'] }}>
                                                            <span
                                                                style="display: flex; justify-content: space-between;align-items: center;">
                                                                <h6>{{ $sat['class_name'] }}</h6>
                                                                <img src="{{ asset($sat['class_icon']) }}"
                                                                    alt="reCycle.png" width="40px" />
                                                            </span><br>
                                                            <p>{{ $sat['music_name'] }}</p>
                                                            <p>{{ $sat['coach_name'] }}</p>
                                                    ...
                                                    <div style=" padding-top: 3%">
                                                        <form method="post" action="{{ $sat['UnBook'] }}">
                                                            <button type="submit" class="btn btn-success btn-flat">
                                                                UnBook
                                                            </button>
                                                            @csrf
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <div>
                                                            <a href="{{ route('web_calander_data', ['id' => $sat['id'], 'date' => $sat['bookdate']]) }}"
                                                                . {{ $sat['id'] }}>
                                                                <span
                                                                    style="display: flex; justify-content: space-between;align-items: center;">
                                                                    <h6>{{ $sat['class_name'] }}</h6>
            ...
            <!-- <section class="Main-content" data-content-field="main-content">
                                                                                                                                                                                                                                                                                                          <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1625525712897" id="page-60e38d4b1b5b112f454f4a56"><div class="row sqs-row"><div class="col sqs-col-12 span-12"><div class="sqs-block code-block sqs-block-code" data-block-type="23" id="block-7c79262e5a4fc3704a41"><div class="sqs-block-content"><iframe src="https://JUNK-fit.myperformanceiq.com/bookings?set_location=146" width="100%" sandbox="allow-same-origin allow-popups allow-scripts allow-forms" scrolling="no"  frameBorder="0"></iframe></div></div></div></div></div>
                                                                                                                                                                                                                                                                                                        </section> -->
