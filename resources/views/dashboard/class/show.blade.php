...
@section('pageTitle','Show class-'.$class->name)
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Show class | {{$class->name}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            {{ Breadcrumbs::render('classes.show',$class->id) }}
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Show class | {{$class->name}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="editClass" action="#" method="post" enctype="multipart/form-data">
                                @csrf
                                @method("POST")
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Name</label>
                                        <input readonly value="{{$class->name}}" type="text" name="name" class="form-control" id="exampleInputName1" placeholder="Enter name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  name="type" class="form-control" id="exampleInputType1">
                                            ...
                                            <option value="Ulitmate Classes">Ulitmate Classes</option>
                                            <option value="Brazillian Jiu-Jitsu">Brazillian Jiu-Jitsu</option>
