...
@section('pageTitle', 'Create new coach')
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            {{ Breadcrumbs::render('web_create_coach') }}
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Create new coach</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="createUser" action="{{ route('web_create_coach') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method("POST")
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputName5">Image</label>
                                        <input type="file" name="image" class="form-control" id="exampleInputName5">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="emergency_contact_relation" class="form-control"
                                            id="exampleInputCountry20" placeholder="Enter Emergency Contact Relationship">
                                    </div>
                                    <div class="form-group">
